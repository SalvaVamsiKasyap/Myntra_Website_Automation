...
from pageObject.myntra_cheap_tshirt_selection import myntra_cheap_tshirt_selection
from pageObject.cheap_shirts_add_to_cart import cheap_shirts_add_to_cart
...
class Testmyntra(BaseClass):
    ...
    def test_add_saree_to_cart(self):
        ...
        self.verify_element_clickable("//div[@data-reactid='334']/a")
        mlgd.kid()
        self.verify_element_clickable("//li[@data-reactid='344']/a")
        mlgd.tshirt()


        mctss = myntra_cheap_tshirt_selection(self.driver)
        self.verify_element_clickable('//div[@class="horizontal-filters-sortContainer"]/div/div/div')
        mctss.moving_to_sort_option()
        csadtc = cheap_shirts_add_to_cart(self.driver)
        csadtc.clickonitem()

        # #myntratshirtselection
